          ...
          <div className="relative h-[420px] sm:h-[520px] lg:h-[600px] perspective-1000">
            ...
            >
              ...
              <div className="absolute top-4 left-1/2 -translate-x-1/2 w-[78%] aspect-[3/4] rounded-3xl overflow-hidden shadow-3d ring-1 ring-white/20 animate-float-slow">
                <img src={plant.url} alt="Strawberry plant" className="h-full w-full object-cover" />
              ...
              <div className="absolute -left-2 sm:left-0 top-20 w-40 sm:w-52 aspect-square rounded-2xl overflow-hidden shadow-3d ring-1 ring-white/20 animate-float-medium">
                <img src={roots.url} alt="Root-inspected saplings" className="h-full w-full object-cover" />
              </div>
              {/* right small */}
              <div className="absolute -right-2 sm:right-0 bottom-8 w-44 sm:w-56 aspect-[4/5] rounded-2xl overflow-hidden shadow-3d ring-1 ring-white/20 animate-float-slow">
                <img src={berries.url} alt="Fresh strawberries" className="h-full w-full object-cover" />
              </div>
              {/* badge */}
      ...
      <section id="dispatch" className="relative py-20 md:py-24 bg-hero text-primary-foreground overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { img: boxes.url, label: "Export-grade boxes" },
              { img: crates.url, label: "Cold-chain crates" },
              { img: bagged.url, label: "Root-bagged saplings" },
              { img: nursery2.url, label: "Poly-house grown" },
            ].map((it, i) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 md:col-span-8 aspect-[16/10] rounded-3xl overflow-hidden shadow-3d card-3d">
              <img src={nursery1.url} alt="Nursery shade house" className="h-full w-full object-cover" />
            </div>
            <div className="col-span-6 md:col-span-4 aspect-square rounded-3xl overflow-hidden shadow-3d card-3d">
              <img src={berries.url} alt="Harvested strawberries" className="h-full w-full object-cover" />
            </div>
            <div className="col-span-6 md:col-span-4 aspect-square rounded-3xl overflow-hidden shadow-3d card-3d">
              <img src={roots.url} alt="Root-inspected runners" className="h-full w-full object-cover" />
            </div>
            <div className="col-span-6 md:col-span-4 aspect-square rounded-3xl overflow-hidden shadow-3d card-3d">
              <img src={bagged.url} alt="Bagged saplings" className="h-full w-full object-cover" />
            </div>
            <div className="col-span-6 md:col-span-4 aspect-square rounded-3xl overflow-hidden shadow-3d card-3d">
              <img src={field.url} alt="Field planting" className="h-full w-full object-cover" />
            </div>
          </div>
        </div>
      </section>
